...
-- ==========================================
-- Outer boundary that clips overflowing map graphics (Adjusted to fit inside the template Inset)
...
-- 3. Buttons & Grips
-- ==========================================
-- (The CloseButton is automatically created by the BasicFrameTemplateWithInset)
    ...
    function _G.UpdateQuestList()
        ...
        for i, filterName in ipairs(sortedFilters) do
            ...
            tab:SetScript("OnClick", function()
                activeFilter = filterName; _G.UpdateQuestList()
            end)
            tab:Show()
        end
